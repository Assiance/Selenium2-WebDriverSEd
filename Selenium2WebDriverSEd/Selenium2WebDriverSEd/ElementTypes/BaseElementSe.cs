...
{
    public class BaseElementSe : IWebElement
    {
        public BaseElementSe()
        {            
        }

        public BaseElementSe(IWebElement webElement)
        {
            WebElement = webElement;
            InitializeJavaScriptExecutor();
        }

        public BaseElementSe(IWebDriver webDriver, By by)
        {
            try
            {
        ...
        public BaseElementSe(IWebElement webElement, By by)
        {
            try
            {
        ...
        public BaseElementSe(IWebDriver webDriver, By by, Func<IWebElement, bool> predicate)
        {
            try
            {
        ...
        public BaseElementSe(IWebElement webElement, By by, Func<IWebElement, bool> predicate)
        {
            try
            {
        ...
        public BaseElementSe Parent
        {
            get
            {
                return new BaseElementSe(WebElement, By.XPath("./parent::*"));
            } 
        }

        public BaseElementSe Child
        {
            get
            {
                return new BaseElementSe(WebElement, By.XPath("./child::*"));
            }
        }
        ...
        public BaseElementSe NextSibling
        {
            get
            {
                return new BaseElementSe(WebElement, By.XPath("./following-sibling::*"));
            }
        }
        ...
        public T ConvertTo<T>() where T : BaseElementSe
        {
        ...
        public BaseElementSe FindElementSe(By by)
        {
            return new BaseElementSe(WebElement.FindElement(by));
        }
